...
<body style="background:#eee;">
  <div class="header">
    <!-- <div class=""> -->
    <div style="display: flex; flex-direction:row; justify-content: space-between; flex-wrap:wrap; align-items:center; align-content:center;">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          <li <?php if (isset($_GET['q']) && $_GET['q'] == 0) echo 'class="active"'; ?> ><a href="dash.php?q=0">Home<span class="sr-only">(current)</span></a></li>
          <li <?php if (isset($_GET['q']) && $_GET['q'] == 1) echo 'class="active"'; ?> ><a href="dash.php?q=1">User</a></li>
          <li <?php if (isset($_GET['q']) && $_GET['q'] == 2) echo 'class="active"'; ?> ><a href="dash.php?q=2">Ranking</a></li>
          <li <?php if (isset($_GET['q']) && $_GET['q'] == 3) echo 'class="active"'; ?> ><a href="dash.php?q=3">Feedback</a></li>
          <li class="dropdown <?php if ((isset($_GET['q']) && $_GET['q'] == 4) || (isset($_GET['q']) && $_GET['q'] == 5)) echo 'active'; ?>">
          ...
          while ($row = mysqli_fetch_array($result)) 
          {
            ...
            else 
            {
              echo '<tr style="color:#99cc32">
                      ...
                      <td>' . $sahi * $total . '</td>
                      <td>' . $time . '&nbsp;min</td>
                      <td><input type="checkbox" data-toggle="toggle" data-on="Enabled" data-off="Disabled" data-onstyle="success" data-offstyle="danger" unchecked></td>
                    </tr>';
            }
          }
          $c = 0;
        ...
        if (isset($_GET['q']) && $_GET['q'] == 3) 
        {
          ...
          while ($row = mysqli_fetch_array($result)) 
          {
            ...
            echo '<tr>
                    ...
                    <td><a title="Delete Feedback" href="update.php?fdid=' . $id . '"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td>
	                </tr>';
          }
          echo '    </table>
                  </div>
        ...
        <?php if (isset($_GET['q']) && $_GET['q'] == 5) {
          ...
          while ($row = mysqli_fetch_array($result)) {
            ...
            echo '<tr>  
                    ...
                    <td>' . $time . '&nbsp;min</td>
	                  <td><b>
                      <a href="update.php?q=rmquiz&eid=' . $eid . '" class="btn sub1" style="margin:0px;background:red">
