    ...
    <div class="row">
      ...
      <div class="col-md-4 col-md-offset-2">
        ...
        if (!(isset($_SESSION['email']))) {
          ...
          include_once 'dbConnection.php';
          echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php?q=1" class="log log1">' . $name . '</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><button onclick=window.close("./online-examination-systen-in-php-master-1/account.php?q=1");><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
        } ?>
      </div>
    </div>
  </div>
